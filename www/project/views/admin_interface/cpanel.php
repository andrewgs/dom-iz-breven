...
<body>
	<div id="container">
	    ...
	    <div id="main" class="container_12 clearfix">
	    	<div class="grid_12">
				<hr size="2"/>
				<?php $this->load->view('admin_interface/messages-list'); ?>
				<div class="clear"></div>
	    	</div>
	    </div>
				...
				function(data){
					if(data.status){
						$("tr[rID='"+curID+"']").fadeOut("slow",function(){
							$("tr[rID='"+curID+"']").remove();
							$.jGrowl("Сообщение удалено!",{header:'Сообщения пользователей'});
						});
					}else
						$.jGrowl(data.message,{header:'Сообщения пользователей'});
				},"json");
		});
	});
</script>
