...
<body>
	<div id="container">
	    ...
	    <div id="main" class="container_12 clearfix">
	    	...
	    	<div class="grid_3">
	    		<a class="project" href="<?=$baseurl;?>proekti-derevyannih-domov-do-100m2"><img alt="Дом из оцилиндрованного бревна" src="<?=$baseurl;?>img/projects/db_1_s.jpg"></a>
	    	...
	    	<div class="grid_9">
	    		<a class="project" href="proekti-derevyannih-domov-ot-100m2-do-200m2"><img alt="Дом из оцилиндрованного бревна" src="<?=$baseurl;?>img/projects/db_1_s.jpg"></a>
	    	...
	    	<div class="grid_3">
	    		<a class="project" href="proekti-derevyannih-domov-ot-200m2-do-300m2"><img alt="Дом из оцилиндрованного бревна" src="<?=$baseurl;?>img/projects/db_1_s.jpg"></a>
	    	...
	    	<div class="grid_9">
				<a class="project" href="<?=$baseurl;?>proekti-derevyannih-domov-ot-300m2"><img alt="Дом из оцилиндрованного бревна" src="<?=$baseurl;?>img/projects/db_1_s.jpg"></a>
